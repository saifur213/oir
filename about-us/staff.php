...
<html lang="en">
    <head>
        ...
        <title>Staffs |  Ofiice Of Industry Relations</title>
        ...
        <div id="layoutDefault">
            <div id="layoutDefault_content">
                <main>
                        ...
                        <div class="page-header-ui-content pt-10">
                            <div class="container px-5 text-center">
                                <div class="row gx-5 justify-content-center">
                                    <div class="col-lg-8">
                                        <h1 class="page-header-ui-title mb-3">Staffs</h1>
                    ...
                    <section class="team_section clearfix bg-light py-10">
                        <div class="container px-5">
                            <div class="row gx-5 align-items-center justify-content-center">
                                    ...
                                    $query = $mysqli->query("SELECT * FROM staff ORDER BY id DESC");

                                    if($query->num_rows > 0){
                                    while($row = $query->fetch_assoc()){
                                    $imageURL = '../images/'.$row["img"];
                                    $name = $row["name"];
                                    $desig = $row["designation"];
                                    ?>

                                    <div class="col span_1_of_4 Box">
                                        <img class="team-image" src="<?php echo $imageURL; ?>" alt="<?php echo $name; ?>">
                                        <h3><?php echo $name; ?></h3>
                                        <span class="role"><?php echo $desig; ?></span>
