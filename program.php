...
<html lang="en">
    <head>
        ...
        <title>Our Program |  Ofiice Of Industry Relations</title>
                ...
                <main>
                    ...
                    <nav class="navbar navbar-marketing navbar-expand-lg bg-white navbar-light fixed-top">
                        <div class="container px-5">
                            <a class="navbar-brand text-primary" href="index.html"> Ofiice Of Industry Relations</a>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav ms-auto me-lg-5">
                                    ...
                                    <li class="nav-item"><a class="nav-link active" href="program.php">Our Program</a></li>
                                    <li class="nav-item dropdown no-caret">
                                        <a class="nav-link dropdown-toggle" id="navbarDropdownDocs" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            News & Media
                                            <i class="fas fa-chevron-right dropdown-arrow"></i>
                        ...
                        <div class="page-header-ui-content pt-10">
                            <div class="container px-5 text-center">
                                <div class="row gx-5 justify-content-center">
                                    <div class="col-lg-8">
                                        <h1 class="page-header-ui-title mb-3">Our Program</h1>
                        ...
                        <div class="container px-5">
                            ...
                            <div class="row gx-5">
                                    ...
                                    <div id="singleBlock"class="col-md-3">
                                        ...
                                        <div id="blockTitle"><h3><?php echo $name; ?><h3></div>
                                        <div id="blockContent"><p>
                                             <?php echo $descrip; ?>
                                        </p> </div>
                                        <a href="<?php echo $link; ?>">
                                            <button class="btn btn-primary " type="button">Visit Program</button>
                                        </a>
                                        </div> 
                                    </div>
                                ...
                                <!-- <div id="singleBlock"class="col-md-3">
                                    <div id="innerBlock">
                                     ...
                                     <img src="images/star-program-autumn-22.png"/>
                                     
                                      <div id="blockTitle"><h3>STAR WORKSHOP<h3></div>
                                      <div id="blockContent"><p>
                                        This website is about the consoling on those student who are in probation(CGPA bellow 2.5).You will know about the event that IUB is organizing for those student. Find more on event section
                                      </p> </div>
                                      <a href="../star_program/index.php">
                                        <button class="btn btn-primary " type="button">Visit Program</button>
                                      </a>
                                     </div> 
                                </div>
                                <div id="singleBlock"class="col-md-3">
                                    <div id="innerBlock">
                                     ...
                                     <img src="images/star-program-autumn-22.png"/>
                                      ...
                                      <div id="blockTitle"><h3>E-THINK<h3></div>
                                      <div id="blockContent"><p>
                                        This website is about the consoling on those student who are in probation(CGPA bellow 2.5).You will know about the event that IUB is organizing for those student. Find more on event section
                                      </p> </div>
                                      <a href="../star_program/index.php">
